...
>
	<SC.Group position={[0, -height / 2, 0]}>
		...
		/>
		<SC.Primitive
			object={new THREE.GridHelper(50, 50, 'orange', 'orange')}
			position={[0, 0.001, 0]}
		/>
	</SC.Group>
	...
	<SC.Mesh
		...
		map: new THREE.TextureLoader().load('/images/phead.jpeg'),
...
<img src="images/tries.jpg" height="200" width="200" style="transform:rotate(90deg);"/>
</div>
